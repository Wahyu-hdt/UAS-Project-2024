...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 w-full z-50 font-Poppins bg-gray-600 backdrop-blur-md bg-opacity-30 border-b border-gray-500">
      {/* Navbar container */}
      <div className="max-w-screen-xl mx-auto flex items-center justify-between p-3">
        ...
        <div className="flex items-center space-x-2">
          <Link
            to="/UAS-Project-2024/checkout"
            className="hover:bg-gray-400 p-2 rounded-sm transition duration-300 ease-in-out"
          >
            <svg
              width="36px"
              height="36px"
          ...
          <span className="flex bg-yellow-400 w-5 h-5 rounded-full items-center justify-center text-xs font-bold">
            {cart.length}
          </span>
        </div>
      </div>
